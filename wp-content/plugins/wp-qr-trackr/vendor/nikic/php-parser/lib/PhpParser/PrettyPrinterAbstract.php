...
abstract class PrettyPrinterAbstract implements PrettyPrinter {
	...
	protected array $precedenceMap = array(
		...
		Expr\Clone_::class             => array( -10, 0, 1 ),
		BinaryOp\Pow::class            => array( 0, 0, 1 ),
		Expr\BitwiseNot::class         => array( 10, -1, -1 ),
		Expr\UnaryPlus::class          => array( 10, -1, -1 ),
		Expr\UnaryMinus::class         => array( 10, -1, -1 ),
		Cast\Int_::class               => array( 10, -1, -1 ),
		Cast\Double::class             => array( 10, -1, -1 ),
		Cast\String_::class            => array( 10, -1, -1 ),
		Cast\Array_::class             => array( 10, -1, -1 ),
		Cast\Object_::class            => array( 10, -1, -1 ),
		Cast\Bool_::class              => array( 10, -1, -1 ),
		Cast\Unset_::class             => array( 10, -1, -1 ),
		Expr\ErrorSuppress::class      => array( 10, -1, -1 ),
		Expr\Instanceof_::class        => array( 20, -1, -1 ),
		Expr\BooleanNot::class         => array( 30, -1, -1 ),
		BinaryOp\Mul::class            => array( 40, 41, 40 ),
		BinaryOp\Div::class            => array( 40, 41, 40 ),
		BinaryOp\Mod::class            => array( 40, 41, 40 ),
		BinaryOp\Plus::class           => array( 50, 51, 50 ),
		BinaryOp\Minus::class          => array( 50, 51, 50 ),
		BinaryOp\Concat::class         => array( 50, 51, 50 ),
		BinaryOp\ShiftLeft::class      => array( 60, 61, 60 ),
		BinaryOp\ShiftRight::class     => array( 60, 61, 60 ),
		BinaryOp\Smaller::class        => array( 70, 70, 70 ),
		BinaryOp\SmallerOrEqual::class => array( 70, 70, 70 ),
		BinaryOp\Greater::class        => array( 70, 70, 70 ),
		BinaryOp\GreaterOrEqual::class => array( 70, 70, 70 ),
		BinaryOp\Equal::class          => array( 80, 80, 80 ),
		BinaryOp\NotEqual::class       => array( 80, 80, 80 ),
		BinaryOp\Identical::class      => array( 80, 80, 80 ),
		BinaryOp\NotIdentical::class   => array( 80, 80, 80 ),
		BinaryOp\Spaceship::class      => array( 80, 80, 80 ),
		BinaryOp\BitwiseAnd::class     => array( 90, 91, 90 ),
		BinaryOp\BitwiseXor::class     => array( 100, 101, 100 ),
		BinaryOp\BitwiseOr::class      => array( 110, 111, 110 ),
		BinaryOp\BooleanAnd::class     => array( 120, 121, 120 ),
		BinaryOp\BooleanOr::class      => array( 130, 131, 130 ),
		BinaryOp\Coalesce::class       => array( 140, 140, 141 ),
		Expr\Ternary::class            => array( 150, 150, 150 ),
		Expr\Assign::class             => array( 160, -1, -1 ),
		Expr\AssignRef::class          => array( 160, -1, -1 ),
		AssignOp\Plus::class           => array( 160, -1, -1 ),
		AssignOp\Minus::class          => array( 160, -1, -1 ),
		AssignOp\Mul::class            => array( 160, -1, -1 ),
		AssignOp\Div::class            => array( 160, -1, -1 ),
		AssignOp\Concat::class         => array( 160, -1, -1 ),
		AssignOp\Mod::class            => array( 160, -1, -1 ),
		AssignOp\BitwiseAnd::class     => array( 160, -1, -1 ),
		AssignOp\BitwiseOr::class      => array( 160, -1, -1 ),
		AssignOp\BitwiseXor::class     => array( 160, -1, -1 ),
		AssignOp\ShiftLeft::class      => array( 160, -1, -1 ),
		AssignOp\ShiftRight::class     => array( 160, -1, -1 ),
		AssignOp\Pow::class            => array( 160, -1, -1 ),
		AssignOp\Coalesce::class       => array( 160, -1, -1 ),
		Expr\YieldFrom::class          => array( 170, -1, -1 ),
		Expr\Yield_::class             => array( 175, -1, -1 ),
		Expr\Print_::class             => array( 180, -1, -1 ),
		BinaryOp\LogicalAnd::class     => array( 190, 191, 190 ),
		BinaryOp\LogicalXor::class     => array( 200, 201, 200 ),
		BinaryOp\LogicalOr::class      => array( 210, 211, 210 ),
		Expr\Include_::class           => array( 220, -1, -1 ),
		Expr\ArrowFunction::class      => array( 230, -1, -1 ),
		Expr\Throw_::class             => array( 240, -1, -1 ),
	);
	...
	protected function pArray(
		...
		foreach ( $diff as $i => $diffElem ) {
			...
			if ( $diffType === DiffElem::TYPE_KEEP || $diffType === DiffElem::TYPE_REPLACE ) {
				...
				} elseif ( $isStmtList && $this->origTokens->haveTagInRange( $pos, $itemStartPos ) ) {
						// We'd remove an opening/closing PHP tag.
						// TODO: Preserve formatting.
						return null;
				}
	...
	protected function initializeNodeListDiffer(): void {
		...
		$this->nodeListDiffer = new Internal\Differ(
			function ( $a, $b ) {
	...
	protected function initializeFixupMap(): void {
		...
		$this->fixupMap = array(
			Expr\Instanceof_::class           => array(
				'expr'  => self::FIXUP_PREC_UNARY,
				'class' => self::FIXUP_NEW,
			),
			Expr\Ternary::class               => array(
				'cond' => self::FIXUP_PREC_LEFT,
				'else' => self::FIXUP_PREC_RIGHT,
			),
			Expr\Yield_::class                => array( 'value' => self::FIXUP_PREC_UNARY ),

			Expr\FuncCall::class              => array( 'name' => self::FIXUP_CALL_LHS ),
			Expr\StaticCall::class            => array( 'class' => self::FIXUP_STATIC_DEREF_LHS ),
			Expr\ArrayDimFetch::class         => array( 'var' => self::FIXUP_DEREF_LHS ),
			Expr\ClassConstFetch::class       => array(
				'class' => self::FIXUP_STATIC_DEREF_LHS,
				'name'  => self::FIXUP_BRACED_NAME,
			),
			Expr\New_::class                  => array( 'class' => self::FIXUP_NEW ),
			Expr\MethodCall::class            => array(
				'var'  => self::FIXUP_DEREF_LHS,
				'name' => self::FIXUP_BRACED_NAME,
			),
			Expr\NullsafeMethodCall::class    => array(
				'var'  => self::FIXUP_DEREF_LHS,
				'name' => self::FIXUP_BRACED_NAME,
			),
			Expr\StaticPropertyFetch::class   => array(
				'class' => self::FIXUP_STATIC_DEREF_LHS,
				'name'  => self::FIXUP_VAR_BRACED_NAME,
			),
			Expr\PropertyFetch::class         => array(
				'var'  => self::FIXUP_DEREF_LHS,
				'name' => self::FIXUP_BRACED_NAME,
			),
			Expr\NullsafePropertyFetch::class => array(
				'var'  => self::FIXUP_DEREF_LHS,
				'name' => self::FIXUP_BRACED_NAME,
			),
			Scalar\InterpolatedString::class  => array(
		...
		foreach ( $prefixOps as $prefixOp ) {
			$this->fixupMap[ $prefixOp ] = array( 'expr' => self::FIXUP_PREC_UNARY );
		}
	}
	...
	protected function initializeRemovalMap(): void {
		...
		$stripLeft        = array( 'left' => \T_WHITESPACE );
		$stripRight       = array( 'right' => \T_WHITESPACE );
		$stripDoubleArrow = array( 'right' => \T_DOUBLE_ARROW );
		$stripColon       = array( 'left' => ':' );
		$stripEquals      = array( 'left' => '=' );
		$this->removalMap = array(
			...
			'Stmt_Class->extends'                    => array( 'left' => \T_EXTENDS ),
			'Stmt_Enum->scalarType'                  => $stripColon,
			'Stmt_EnumCase->expr'                    => $stripEquals,
			'Expr_PrintableNewAnonClass->extends'    => array( 'left' => \T_EXTENDS ),
	...
	protected function initializeInsertionMap(): void {
		...
		$this->insertionMap = array(
			'Expr_ArrayDimFetch->dim'             => array( '[', false, null, null ),
			'ArrayItem->key'                      => array( null, false, null, ' => ' ),
			'Expr_ArrowFunction->returnType'      => array( ')', false, ': ', null ),
			'Expr_Closure->returnType'            => array( ')', false, ': ', null ),
			'Expr_Ternary->if'                    => array( '?', false, ' ', ' ' ),
			'Expr_Yield->key'                     => array( \T_YIELD, false, null, ' => ' ),
			'Expr_Yield->value'                   => array( \T_YIELD, false, ' ', null ),
			'Param->type'                         => array( null, false, null, ' ' ),
			'Param->default'                      => array( null, false, ' = ', null ),
			'Stmt_Break->num'                     => array( \T_BREAK, false, ' ', null ),
			'Stmt_Catch->var'                     => array( null, false, ' ', null ),
			'Stmt_ClassMethod->returnType'        => array( ')', false, ': ', null ),
			'Stmt_ClassConst->type'               => array( \T_CONST, false, ' ', null ),
			'Stmt_Class->extends'                 => array( null, false, ' extends ', null ),
			'Stmt_Enum->scalarType'               => array( null, false, ' : ', null ),
			'Stmt_EnumCase->expr'                 => array( null, false, ' = ', null ),
			'Expr_PrintableNewAnonClass->extends' => array( null, false, ' extends ', null ),
			'Stmt_Continue->num'                  => array( \T_CONTINUE, false, ' ', null ),
			'Stmt_Foreach->keyVar'                => array( \T_AS, false, null, ' => ' ),
			'Stmt_Function->returnType'           => array( ')', false, ': ', null ),
			'Stmt_If->else'                       => array( null, false, ' ', null ),
			'Stmt_Namespace->name'                => array( \T_NAMESPACE, false, ' ', null ),
			'Stmt_Property->type'                 => array( \T_VARIABLE, true, null, ' ' ),
			'PropertyItem->default'               => array( null, false, ' = ', null ),
			'Stmt_Return->expr'                   => array( \T_RETURN, false, ' ', null ),
			'Stmt_StaticVar->default'             => array( null, false, ' = ', null ),
			// 'Stmt_TraitUseAdaptation_Alias->newName' => [T_AS, false, ' ', null], // TODO
			'Stmt_TryCatch->finally'              => array( null, false, ' ', null ),
	...
	protected function initializeEmptyListInsertionMap(): void {
		...
		$this->emptyListInsertionMap = array(
			Expr\ArrowFunction::class . '->params'      => array( '(', '', '' ),
			Expr\Closure::class . '->uses'              => array( ')', ' use (', ')' ),
			Expr\Closure::class . '->params'            => array( '(', '', '' ),
			Expr\FuncCall::class . '->args'             => array( '(', '', '' ),
			Expr\MethodCall::class . '->args'           => array( '(', '', '' ),
			Expr\NullsafeMethodCall::class . '->args'   => array( '(', '', '' ),
			Expr\New_::class . '->args'                 => array( '(', '', '' ),
			PrintableNewAnonClassNode::class . '->args' => array( '(', '', '' ),
			PrintableNewAnonClassNode::class . '->implements' => array( null, ' implements ', '' ),
			Expr\StaticCall::class . '->args'           => array( '(', '', '' ),
			Stmt\Class_::class . '->implements'         => array( null, ' implements ', '' ),
			Stmt\Enum_::class . '->implements'          => array( null, ' implements ', '' ),
			Stmt\ClassMethod::class . '->params'        => array( '(', '', '' ),
			Stmt\Interface_::class . '->extends'        => array( null, ' extends ', '' ),
			Stmt\Function_::class . '->params'          => array( '(', '', '' ),
			Stmt\Interface_::class . '->attrGroups'     => array( null, '', "\n" ),
			Stmt\Class_::class . '->attrGroups'         => array( null, '', "\n" ),
			Stmt\ClassConst::class . '->attrGroups'     => array( null, '', "\n" ),
			Stmt\ClassMethod::class . '->attrGroups'    => array( null, '', "\n" ),
			Stmt\Function_::class . '->attrGroups'      => array( null, '', "\n" ),
			Stmt\Property::class . '->attrGroups'       => array( null, '', "\n" ),
			Stmt\Trait_::class . '->attrGroups'         => array( null, '', "\n" ),
			Expr\ArrowFunction::class . '->attrGroups'  => array( null, '', ' ' ),
			Expr\Closure::class . '->attrGroups'        => array( null, '', ' ' ),
			Stmt\Const_::class . '->attrGroups'         => array( null, '', "\n" ),
			PrintableNewAnonClassNode::class . '->attrGroups' => array( \T_NEW, ' ', '' ),
	...
	protected function initializeModifierChangeMap(): void {
		...
		$this->modifierChangeMap = array(
			Stmt\ClassConst::class . '->flags'           => array( 'pModifiers', \T_CONST ),
			Stmt\ClassMethod::class . '->flags'          => array( 'pModifiers', \T_FUNCTION ),
			Stmt\Class_::class . '->flags'               => array( 'pModifiers', \T_CLASS ),
			Stmt\Property::class . '->flags'             => array( 'pModifiers', \T_VARIABLE ),
			PrintableNewAnonClassNode::class . '->flags' => array( 'pModifiers', \T_CLASS ),
			Param::class . '->flags'                     => array( 'pModifiers', \T_VARIABLE ),
			PropertyHook::class . '->flags'              => array( 'pModifiers', \T_STRING ),
			Expr\Closure::class . '->static'             => array( 'pStatic', \T_FUNCTION ),
			Expr\ArrowFunction::class . '->static'       => array( 'pStatic', \T_FN ),
