...
class Reflector {
	 ...
	 * @var list<string>
	 */
	public const BUILTIN_TYPES = array( 'array', 'bool', 'int', 'float', 'null', 'object', 'string' );
	 ...
	 * @var list<string>
	 */
	public const RESERVED_WORDS = array( 'bool', 'true', 'false', 'float', 'int', 'iterable', 'mixed', 'never', 'null', 'object', 'string', 'void' );
	 ...
	 * @var list<string>
	 */
	private const TRAVERSABLE_ARRAY = array( '\Traversable', 'array' );
