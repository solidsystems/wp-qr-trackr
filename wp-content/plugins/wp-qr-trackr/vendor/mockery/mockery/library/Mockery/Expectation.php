...
class Expectation implements ExpectationInterface {
	...
	public function andReturnArg( $index ) {
		...
		$this->_closureQueue = array( $closure );
	...
	public function isCallCountConstrained() {
		return $this->_countValidators !== array();
	}
	...
	public function withAnyArgs() {
		$this->_expectedArgs = array( new AnyArgs() );
	...
	public function withNoArgs() {
		$this->_expectedArgs = array( new NoArgs() );
	...
	public function withSomeOfArgs( ...$expectedArgs ) {
		return $this->withArgs(
			static function ( ...$args ) use ( $expectedArgs ): bool {
	...
	private function isArgumentListMatcher() {
		return $this->_expectedArgs !== array() && $this->_expectedArgs[0] instanceof ArgumentListMatcher;
	}
	...
	private function withArgsMatchedByClosure( Closure $closure ) {
		$this->_expectedArgs = array( new MultiArgumentClosure( $closure ) );
