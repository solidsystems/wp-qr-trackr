...
final class ProcessRulesetShouldProcessElementTest extends TestCase {
	 ...
	 */
	private static $originalIniValues = array(
		'bcmath.scale' => null,
		'docref_root'  => null,
		'user_agent'   => null,
	);
	...
	protected function initializeConfigAndRuleset() {
		if ( isset( self::$ruleset ) === false ) {
			...
			self::$config  = new ConfigDouble( array( "--standard=$standard" ) );
	...
	public function testShouldProcessArgCsonly() {
		...
		$expectedReports    = array( 'full' => null );
	...
	public function testShouldProcessArgCbfonly() {
		...
		$expectedReports    = array( 'summary' => null );
	...
	public function testShouldProcessRuleExcludeCsonly() {
		...
		$expected = array(
			'PEAR.Formatting.MultiLineAssignment.Indent' => array(
				'severity' => 0,
			),
		);
	...
	public function testShouldProcessRuleExcludeCbfonly() {
		...
		$expected = array(
			'PEAR.Formatting.MultiLineAssignment.EqualSignLine' => array(
				'severity' => 0,
			),
		);
