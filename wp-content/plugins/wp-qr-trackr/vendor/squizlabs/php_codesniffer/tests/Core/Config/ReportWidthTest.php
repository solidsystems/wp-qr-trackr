...
final class ReportWidthTest extends AbstractRealConfigTestCase {
	...
	public function testReportWidthDefault() {
		$config = new Config( array( '--standard=PSR1' ) );
	...
	public static function dataReportWidthInputHandling() {
		return array(
			'No value (empty string)'               => array(
				'value'    => '',
				'expected' => Config::DEFAULT_REPORT_WIDTH,
			),
			'Value: invalid input type null'        => array(
				'value'    => null,
				'expected' => Config::DEFAULT_REPORT_WIDTH,
			),
			'Value: invalid input type false'       => array(
				'value'    => false,
				'expected' => Config::DEFAULT_REPORT_WIDTH,
			),
			'Value: invalid input type float'       => array(
				'value'    => 100.50,
				'expected' => Config::DEFAULT_REPORT_WIDTH,
			),
			'Value: invalid string value "invalid"' => array(
				'value'    => 'invalid',
				'expected' => Config::DEFAULT_REPORT_WIDTH,
			),
			'Value: invalid string value, non-integer string "50.25"' => array(
				'value'    => '50.25',
				'expected' => Config::DEFAULT_REPORT_WIDTH,
			),
			'Value: valid numeric string value'     => array(
				'value'    => '250',
				'expected' => 250,
			),
			'Value: valid int value'                => array(
				'value'    => 220,
				'expected' => 220,
			),
			'Value: negative int value becomes positive int' => array(
				'value'    => -180,
				'expected' => 180,
			),
		);
