...
final class RecurseScopeMapCaseKeywordConditionsTest extends AbstractTokenizerTestCase {
	...
	public function testNotEnumCases( $testMarker, $expectedTokens, $testCloserMarker = null ) {
		$tokens     = $this->phpcsFile->getTokens();
		$caseIndex  = $this->getTargetToken( $testMarker, array( T_ENUM_CASE, T_CASE ) );
	...
	public static function dataNotEnumCases() {
		return array(
			'switch case with constant, semicolon condition end' => array(
			...
			'switch case with constant, colon condition end' => array(
			...
			'switch case with constant, comparison'      => array(
			...
			'switch case with constant, assignment'      => array(
			...
			'switch case with constant, keyword in mixed case' => array(
			...
			'switch case, body in curlies declares enum' => array(
			...
			'switch case, body after semicolon declares enum' => array(
			...
			'switch case, shared closer with switch'     => array(
			...
			'switch case, nested inline if/elseif/else with and without braces' => array(
			...
			'switch case, nested inline if'              => array(
