...
final class NullsafeObjectOperatorTest extends AbstractTokenizerTestCase {
	...
	public static function dataNullsafeObjectOperator() {
		return array(
			'nullsafe operator'                         => array( '/* testNullsafeObjectOperator */' ),
			'illegal nullsafe operator (write context)' => array( '/* testNullsafeObjectOperatorWriteContext */' ),
		);
	...
	public static function dataTernaryThen() {
		return array(
			...
			'whitespace between question mark and object operator' => array(
				'testMarker'         => '/* testParseErrorWhitespaceNotAllowed */',
				'testObjectOperator' => true,
			),
			'comment between question mark and object operator' => array(
				'testMarker'         => '/* testParseErrorCommentNotAllowed */',
				'testObjectOperator' => true,
			),
			'parse error/live coding' => array(
