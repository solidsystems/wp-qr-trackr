...
final class MessageCollectorTest extends TestCase {
	...
	public static function dataAddingNonStringMessageResultsInException() {
		return array(
			...
			'boolean' => array( true ),
			'integer' => array( 10 ),
			'array'   => array( array( 'something' => 'incorrect' ) ),
		);
	...
	public static function dataAddingMessageWithUnsupportedMessageTypeResultsInException() {
		return array(
			...
			'integer which doesn\'t match any of the message type constants: -235' => array( -235 ),
			'integer which doesn\'t match any of the message type constants: 0' => array( 0 ),
			'integer which doesn\'t match any of the message type constants: 3' => array( 3 ),
			'integer which doesn\'t match any of the message type constants: 6' => array( 6 ),
			'integer which doesn\'t match any of the message type constants: 123' => array( 123 ),
			'integer which doesn\'t match any of the message type constants: PHP_INT_MAX' => array( PHP_INT_MAX ),
		);
	...
	public static function dataContainsBlockingErrors() {
		return array(
			...
			'Only non-blocking messages'                => array(
				'messages' => array(
			...
			'Mix of blocking and non-blocking messages' => array(
				'messages' => array(
	...
	public static function dataDisplayingBlockingErrors() {
		...
		return array(
			...
			'Errors mixed with non-blocking messages' => array(
				'messages' => array(
					'First deprecation'   => MessageCollector::DEPRECATED,
					'Second warning'      => MessageCollector::WARNING,
					'Third notice'        => MessageCollector::NOTICE,
