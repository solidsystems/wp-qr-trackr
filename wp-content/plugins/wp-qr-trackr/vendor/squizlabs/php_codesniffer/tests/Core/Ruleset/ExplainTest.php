...
final class ExplainTest extends TestCase {
	...
	public function testExplain() {
		// Set up the ruleset.
		$config  = new ConfigDouble( array( '--standard=PSR1', '-e' ) );
	...
	public function testExplainAlwaysDisplaysCompleteSniffName() {
		// Set up the ruleset.
		$config  = new ConfigDouble( array( '--standard=PSR1', '-e', '--report-width=30' ) );
		$ruleset = new Ruleset( $config );
	...
	public function testExplainSingleSniff() {
		...
		$config   = new ConfigDouble( array( "--standard=$standard", '-e' ) );
		$ruleset  = new Ruleset( $config );
