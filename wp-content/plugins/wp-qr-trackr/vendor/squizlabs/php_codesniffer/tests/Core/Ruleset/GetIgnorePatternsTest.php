...
final class GetIgnorePatternsTest extends TestCase {
	...
	public static function dataGetIgnorePatterns() {
		return array(
			...
			'Ignore patterns for PSR1.Classes.ClassDeclaration' => array(
			...
			'Ignore patterns for Generic.Formatting.SpaceAfterCast' => array(
				'listener' => 'Generic.Formatting.SpaceAfterCast',
				'expected' => array( './src/*/test\\.php$' => 'absolute' ),
			),
			'Ignore patterns for sniff without ignore patterns' => array(
