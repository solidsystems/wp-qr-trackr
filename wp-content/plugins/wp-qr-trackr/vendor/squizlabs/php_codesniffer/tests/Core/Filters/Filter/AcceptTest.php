...
final class AcceptTest extends AbstractFilterTestCase {
	...
	public static function initializeConfigAndRuleset() {
		...
		self::$config  = new ConfigDouble( array( "--standard=$standard", '--ignore=*/somethingelse/*' ) );
	...
	public static function dataExcludePatterns() {
		$testCases = array(
			...
			'Non-sniff specific path based excludes from ruleset and command line are respected and don\'t filter out too much' => array(
				'inputPaths'     => array(
			...
			'Filter should not act on standard/sniff specific exclude patterns'                                                 => array(
				'inputPaths'     => array(
