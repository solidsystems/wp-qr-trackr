...
final class PrintProgressTest extends TestCase {
	...
	public static function initializeConfigRulesetRunner() {
		self::$config            = new ConfigDouble( array( '-p' ) );
		self::$config->standards = array( 'Generic' );
		self::$config->sniffs    = array( 'Generic.PHP.LowerCaseConstant' );
	...
	public static function dataEndOfLineSummary() {
		...
		return array(
			...
			'More than 1000 files (1234)'   => array(
				'nrOfFiles' => 1234,
