...
final class GetDeclarationNameTest extends AbstractMethodUnitTest {
	...
	public static function dataGetDeclarationNameNull() {
		return array(
			...
			'anon-class-with-parentheses'            => array(
				'testMarker' => '/* testAnonClassWithParens */',
				'targetType' => T_ANON_CLASS,
			),
			'anon-class-with-parentheses-2'          => array(
				'testMarker' => '/* testAnonClassWithParens2 */',
				'targetType' => T_ANON_CLASS,
			),
			'anon-class-without-parentheses'         => array(
				'testMarker' => '/* testAnonClassWithoutParens */',
				'targetType' => T_ANON_CLASS,
			),
			'anon-class-extends-without-parentheses' => array(
	...
	public static function dataGetDeclarationName() {
		return array(
			...
			'function-return-by-reference'                => array(
			...
			'method-return-by-reference'                  => array(
			...
			'enum-backed-space-between-name-and-colon'    => array(
				'testMarker' => '/* testBackedEnumSpaceBetweenNameAndColon */',
				'expected'   => 'Hoo',
			),
			'enum-backed-no-space-between-name-and-colon' => array(
				'testMarker' => '/* testBackedEnumNoSpaceBetweenNameAndColon */',
				'expected'   => 'Suit',
			),
			'function-return-by-reference-with-reserved-keyword-each' => array(
				'testMarker' => '/* testFunctionReturnByRefWithReservedKeywordEach */',
				'expected'   => 'each',
			),
			'function-return-by-reference-with-reserved-keyword-parent' => array(
				'testMarker' => '/* testFunctionReturnByRefWithReservedKeywordParent */',
				'expected'   => 'parent',
			),
			'function-return-by-reference-with-reserved-keyword-self' => array(
				'testMarker' => '/* testFunctionReturnByRefWithReservedKeywordSelf */',
				'expected'   => 'self',
			),
			'function-return-by-reference-with-reserved-keyword-static' => array(
