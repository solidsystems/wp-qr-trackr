...
final class RecurseScopeMapSwitchTokenScopeTest extends AbstractTokenizerTestCase {
	...
	public function testSwitchScope( $testMarker, $expectedTokens, $testOpenerMarker = null, $testCloserMarker = null ) {
		...
		$switchIndex = $this->getTargetToken( $testMarker, array( T_SWITCH ) );
	...
	public static function dataSwitchScope() {
		return array(
			...
			'switch alternative syntax'                   => array(
			...
			'switch with closure in the condition'        => array(
			...
			'switch alternative syntax with closure containing return type in the condition' => array(
			...
			'switch with arrow function in the condition' => array(
			...
			'switch alternative syntax with arrow function containing return type in the condition' => array(
