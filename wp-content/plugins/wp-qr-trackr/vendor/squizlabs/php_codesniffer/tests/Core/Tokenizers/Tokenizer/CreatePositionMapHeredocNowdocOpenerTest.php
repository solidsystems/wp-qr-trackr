...
final class CreatePositionMapHeredocNowdocOpenerTest extends AbstractTokenizerTestCase {
	...
	public function testHeredocNowdocOpenerTabReplacement( $testMarker, $expected ) {
		...
		$opener = $this->getTargetToken( $testMarker, array( T_START_HEREDOC, T_START_NOWDOC ) );
	...
	public static function dataHeredocNowdocOpenerTabReplacement() {
		return array(
			'Heredoc opener without space' => array(
...
',
			...
			'Nowdoc opener without space'  => array(
...
",
			...
			'Heredoc opener with space(s)' => array(
...
',
			...
			'Nowdoc opener with space(s)'  => array(
...
",
			...
			'Heredoc opener with tab(s)'   => array(
...
',
			...
			'Nowdoc opener with tab(s)'    => array(
