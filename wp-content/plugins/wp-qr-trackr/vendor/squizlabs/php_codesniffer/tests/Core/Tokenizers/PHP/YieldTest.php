...
final class YieldTest extends AbstractTokenizerTestCase {
	...
	public function testYieldKeyword( $testMarker, $expectedContent ) {
		...
		$target     = $this->getTargetToken( $testMarker, array( T_YIELD, T_YIELD_FROM, T_STRING ) );
	...
	public static function dataYieldKeyword() {
		return array(
			...
			'yield followed by comment'         => array(
				'testMarker'      => '/* testYieldFollowedByComment */',
				'expectedContent' => 'YIELD',
			),
			'yield at end of file, live coding' => array(
	...
	public static function dataYieldFromKeywordSingleToken() {
		return array(
			...
			'yield from with extra space between' => array(
				'testMarker'      => '/* testYieldFromWithExtraSpacesBetween */',
				'expectedContent' => 'Yield           From',
			),
			'yield from with tab between'         => array(
	...
	public static function dataYieldFromKeywordMultiToken() {
		return array(
			'yield from with new line'                => array(
...
',
			...
			'yield from with trailing comment'        => array(
...
',
			...
			'yield from with trailing annotation'     => array(
...
',
			...
			'yield from with new line and comment'    => array(
...
',
			...
			'yield from with new line and annotation' => array(
...
',
	...
	public static function dataYieldNonKeyword() {
		return array(
			'yield used as class name'            => array( '/* testYieldUsedAsClassName */' ),
			'yield used as class constant name'   => array( '/* testYieldUsedAsClassConstantName */' ),
			'yield used as method name'           => array( '/* testYieldUsedAsMethodName */' ),
			'yield used as property access 1'     => array( '/* testYieldUsedAsPropertyName1 */' ),
			'yield used as property access 2'     => array( '/* testYieldUsedAsPropertyName2 */' ),
			'yield used as class constant access' => array( '/* testYieldUsedForClassConstantAccess1 */' ),
			'from used as class constant access'  => array( '/* testFromUsedForClassConstantAccess1 */' ),
			'yield used as method name with ref'  => array( '/* testYieldUsedAsMethodNameReturnByRef */' ),
		);
