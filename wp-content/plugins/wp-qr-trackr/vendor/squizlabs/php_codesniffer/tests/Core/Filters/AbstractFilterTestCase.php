...
abstract class AbstractFilterTestCase extends TestCase {
	...
	public static function initializeConfigAndRuleset() {
		self::$config  = new ConfigDouble( array( '--extensions=php,inc/php,js,css' ) );
	 ...
	 */
	protected function getMockedClass( $className, array $constructorArgs = array(), $methodsToMock = null ) {
