...
final class SetSniffPropertyTest extends AbstractRulesetTestCase {
	...
	public static function dataSniffPropertiesGetSetWhenAllowed() {
		return array(
			'Property allowed as explicitly declared'    => array( 'AllowedAsDeclared' ),
			'Property allowed as sniff extends stdClass' => array( 'AllowedViaStdClass' ),
			'Property allowed as sniff has magic __set() method' => array( 'AllowedViaMagicMethod' ),
		);
	...
	public static function dataDirectCallWithOldArrayFormatSetsProperty() {
		return array(
			'Property value is not an array (boolean)' => array(
				'propertyValue' => false,
			),
			'Property value is not an array (string)'  => array(
				'propertyValue' => 'a string',
			),
			'Property value is an empty array'         => array(
				'propertyValue' => array(),
			),
			'Property value is an array without keys'  => array(
				'propertyValue' => array(
					'value',
					false,
				),
			),
			'Property value is an array without the "scope" or "value" keys' => array(
				'propertyValue' => array(
					'key1' => 'value',
					'key2' => false,
				),
			),
			'Property value is an array without the "scope" key' => array(
				'propertyValue' => array(
					'key1'  => 'value',
					'value' => true,
				),
			),
			'Property value is an array without the "value" key' => array(
				'propertyValue' => array(
					'scope' => 'value',
					'key2'  => 1234,
				),
