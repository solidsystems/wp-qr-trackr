...
final class BackfillFnTokenTest extends AbstractTokenizerTestCase {
	...
	public static function dataInMatchValue() {
		return array(
			...
			'last_value_with_trailing_comma'      => array(
			...
			'last_value_without_trailing_comma_1' => array(
			...
			'last_value_without_trailing_comma_2' => array(
	...
	public function testNotAnArrowFunction( $testMarker, $testContent = 'fn' ) {
		...
		$token      = $this->getTargetToken( $testMarker, array( T_STRING, T_FN ), $testContent );
	...
	public static function dataNotAnArrowFunction() {
		return array(
			...
			'name of a constant, context: declaration using "const" keyword - lowercase' => array(
				'testMarker'  => '/* testConstantDeclarationLower */',
				'testContent' => 'fn',
			),
			'name of a (static) method, context: declaration' => array(
				'testMarker' => '/* testStaticMethodName */',
			),
			'name of a property, context: property access' => array(
				'testMarker' => '/* testPropertyAssignment */',
			),
			'name of a method, context: declaration in an anon class - mixed case' => array(
				'testMarker'  => '/* testAnonClassMethodName */',
				'testContent' => 'fN',
			),
			'name of a method, context: static method call' => array(
			...
			'name of a constant, context: constant access - mixed case' => array(
				'testMarker'  => '/* testNonArrowConstantAccessMixed */',
				'testContent' => 'Fn',
			),
			'name of a method, context: method call on object - lowercase' => array(
				'testMarker' => '/* testNonArrowObjectMethodCall */',
			),
			'name of a method, context: method call on object - uppercase' => array(
				'testMarker'  => '/* testNonArrowObjectMethodCallUpper */',
				'testContent' => 'FN',
			),
			'name of a (namespaced) function, context: partially qualified function call' => array(
				'testMarker'  => '/* testNonArrowNamespacedFunctionCall */',
				'testContent' => 'Fn',
			),
			'name of a (namespaced) function, context: namespace relative function call' => array(
				'testMarker' => '/* testNonArrowNamespaceOperatorFunctionCall */',
			),
			'name of a function, context: declaration with union types for param and return' => array(
				'testMarker' => '/* testNonArrowFunctionNameWithUnionTypes */',
			),
			'unknown - live coding/parse error'            => array(
