...
final class ExpandRulesetReferenceInternalTest extends AbstractRulesetTestCase {
	...
	public function testInternalRefDoesNotGetExpanded() {
		...
		$expected = array( 'Generic.PHP.BacktickOperator' => 'PHP_CodeSniffer\\Standards\\Generic\\Sniffs\\PHP\\BacktickOperatorSniff' );
	...
	public function testInternalStandardDoesGetExpanded() {
		...
		$expected = array( 'Internal.Valid.Valid' => 'Fixtures\\Internal\\Sniffs\\Valid\\ValidSniff' );
