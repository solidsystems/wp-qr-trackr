...
final class GetHumanReadableDurationTest extends TestCase {
	...
	public static function dataGetHumanReadableDuration() {
		return array(
			...
			'Duration: 13 milliseconds'                    => array(
				'duration' => 13.232101565,
				'expected' => '13ms',
			),
			'Duration: 14 milliseconds'                    => array(
				'duration' => 13.916015625,
				'expected' => '14ms',
			),
			'Duration: 999 milliseconds'                   => array(
				'duration' => 999.2236,
				'expected' => '999ms',
			),
			'Duration: 999+ milliseconds'                  => array(
			...
			'Duration: 1 second'                           => array(
				'duration' => 1000,
				'expected' => '1 secs',
			),
			'Duration: slightly more than 1 second'        => array(
				'duration' => 1001.178215,
				'expected' => '1 secs',
			),
			'Duration: just under a 1 minute'              => array(
				'duration' => 59999.3851,
				'expected' => '60 secs',
			),
			'Duration: exactly 1 minute'                   => array(
				'duration' => 60000,
				'expected' => '1 mins',
			),
			'Duration: slightly more than 1 minute'        => array(
				'duration' => 60001.7581235,
				'expected' => '1 mins',
			),
			'Duration: 1 minute, just under half a second' => array(
				'duration' => 60499.83639,
				'expected' => '1 mins, 0.5 secs',
			),
			'Duration: 1 minute, just over half a second'  => array(
				'duration' => 60501.961238,
				'expected' => '1 mins, 0.5 secs',
			),
			'Duration: 1 minute, 1 second'                 => array(
				'duration' => 61000,
				'expected' => '1 mins, 1 secs',
			),
			'Duration: exactly 1 hour'                     => array(
				'duration' => 3600000,
				'expected' => '60 mins',
			),
			'Duration: 89.4 mins'                          => array(
				'duration' => 5364000,
