...
final class GotoLabelTest extends AbstractTokenizerTestCase {
	...
	public static function dataGotoStatement() {
		return array(
			'label for goto statement'                 => array(
				'testMarker'  => '/* testGotoStatement */',
				'testContent' => 'marker',
			),
			'label for goto statement in loop, keyword capitalized' => array(
				'testMarker'  => '/* testGotoStatementInLoop */',
				'testContent' => 'end',
			),
			'label for goto statement in switch'       => array(
				'testMarker'  => '/* testGotoStatementInSwitch */',
				'testContent' => 'def',
			),
			'label for goto statement within function' => array(
	...
	public static function dataGotoDeclaration() {
		return array(
			'label in goto declaration - marker' => array(
				'testMarker'  => '/* testGotoDeclaration */',
				'testContent' => 'marker:',
			),
			'label in goto declaration - end'    => array(
				'testMarker'  => '/* testGotoDeclarationOutsideLoop */',
				'testContent' => 'end:',
			),
			'label in goto declaration - def'    => array(
				'testMarker'  => '/* testGotoDeclarationInSwitch */',
				'testContent' => 'def:',
			),
			'label in goto declaration - label'  => array(
	...
	public function testNotAGotoDeclaration( $testMarker, $testContent ) {
		$tokens     = $this->phpcsFile->getTokens();
		$target     = $this->getTargetToken( $testMarker, array( T_GOTO_LABEL, T_STRING ), $testContent );
	...
	public static function dataNotAGotoDeclaration() {
		return array(
			'not goto label - global constant followed by switch-case colon' => array(
				'testMarker'  => '/* testNotGotoDeclarationGlobalConstant */',
				'testContent' => 'CONSTANT',
			),
			'not goto label - namespaced constant followed by switch-case colon' => array(
				'testMarker'  => '/* testNotGotoDeclarationNamespacedConstant */',
				'testContent' => 'CONSTANT',
			),
			'not goto label - class constant followed by switch-case colon' => array(
				'testMarker'  => '/* testNotGotoDeclarationClassConstant */',
				'testContent' => 'CONSTANT',
			),
			'not goto label - class property use followed by switch-case colon' => array(
				'testMarker'  => '/* testNotGotoDeclarationClassProperty */',
				'testContent' => 'property',
			),
			'not goto label - global constant followed by ternary else' => array(
				'testMarker'  => '/* testNotGotoDeclarationGlobalConstantInTernary */',
				'testContent' => 'CONST_A',
			),
			'not goto label - global constant after ternary else' => array(
				'testMarker'  => '/* testNotGotoDeclarationGlobalConstantInTernary */',
				'testContent' => 'CONST_B',
			),
			'not goto label - name of backed enum' => array(
