...
final class ConstructorTest extends AbstractRulesetTestCase {
	...
	public static function dataHandlingStandardsPassedViaCLI() {
		return array(
			'Single standard passed'                     => array(
				'cliArgs'  => array( '--standard=PSR1' ),
				'expected' => 'PSR1',
			),
			'Multiple standards passed'                  => array(
				'cliArgs'  => array( '--standard=PSR1,Zend' ),
				'expected' => 'PSR1, Zend',
			),
			'Absolute path to standard directory passed' => array(
				'cliArgs'  => array(
	...
	public static function dataStandardsAreRegisteredWithAutoloader() {
		...
		$data['Additional non-namespaced standard'] = array(
			'cliArgs'  => array(
				'--standard=MyStandard',
				'--runtime-set',
				'installed_paths',
			...
			'expected' => ( $defaultPaths + array( $extraInstalledPath => 'MyStandard' ) ),
		);

		$extraInstalledPath                     = __DIR__ . DIRECTORY_SEPARATOR . 'Fixtures' . DIRECTORY_SEPARATOR . 'TestStandard';
		$data['Additional namespaced standard'] = array(
			'cliArgs'  => array(
			...
			'expected' => ( $defaultPaths + array( $extraInstalledPath => 'Fixtures\TestStandard' ) ),
		);
	...
	public static function dataCachingVersusRestrictions() {
		...
		return array(
			'No restrictions, cache off'     => array(
				'cliArgs'  => array( '--standard=PSR1' ),
				'cache'    => false,
				'expected' => $completeSet,
			),
			'Has exclusions, cache off'      => array(
				'cliArgs'  => array(
					'--standard=PSR1',
			...
			'Has sniff selection, cache off' => array(
				'cliArgs'  => array(
					'--standard=PSR1',
			...
			'No restrictions, cache on'      => array(
				'cliArgs'  => array( '--standard=PSR1' ),
				'cache'    => true,
				'expected' => $completeSet,
			),
			'Has exclusions, cache on'       => array(
				'cliArgs'  => array(
					'--standard=PSR1',
