...
class Config {
	 ...
	 */
	private static $overriddenDefaults = array();
		...
		switch ( $arg ) {
			...
			case 'runtime-set':
				...
				if ( isset( self::$overriddenDefaults['runtime-set'] ) === false ) {
					self::$overriddenDefaults['runtime-set'] = array();
				}
			...
			default:
				...
				} elseif ( $this->dieOnUnknownArg === false ) {
						$eqPos = strpos( $arg, '=' );
					try {
						$unknown = $this->unknown;
