...
final class Help {
	 ...
	 * @var array<string>
	 */
	private $requestedOptions = array();
	...
	private function getAllOptions() {
		...
		$options['Rule Selection Options'] = array(
			'standard'   => array(
		...
		$options['Reporting Options'] = array(
			'report'             => array(
		...
		$options['Miscellaneous Options'] = array(
			'h'       => array(
				'argument'    => '-h, -?, --help',
