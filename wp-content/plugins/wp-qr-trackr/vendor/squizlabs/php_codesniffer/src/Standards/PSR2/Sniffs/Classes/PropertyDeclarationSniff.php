...
class PropertyDeclarationSniff extends AbstractVariableSniff {
	...
	protected function processMemberVar( File $phpcsFile, $stackPtr ) {
		...
		if ( $propertyInfo['scope_specified'] === true && $propertyInfo['set_scope'] !== false ) {
			$scopePtr    = $phpcsFile->findPrevious( array( T_PUBLIC, T_PROTECTED, T_PRIVATE ), ( $stackPtr - 1 ) );
			$setScopePtr = $phpcsFile->findPrevious( array( T_PUBLIC_SET, T_PROTECTED_SET, T_PRIVATE_SET ), ( $stackPtr - 1 ) );
