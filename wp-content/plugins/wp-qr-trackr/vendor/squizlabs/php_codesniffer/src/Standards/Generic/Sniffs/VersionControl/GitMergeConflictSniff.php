				...
				switch ( $tokens[ $i ]['code'] ) {
					...
					case T_SL:
						...
						&& trim( $tokens[ ( $i + 2 ) ]['content'] ) === '<<< HEAD'
							...
							$phpcsFile->addError( $error, $i, 'OpenerFound', array( 'opener' ) );
							$i += 2;
						}
						break;
					...
					case T_SR:
						...
						&& $tokens[ ( $i + 4 ) ]['content'] === ' '
							...
							$phpcsFile->addError( $error, $i, 'CloserFound', array( 'closer' ) );
							$i += 4;
						}
						break;
					...
					case T_IS_IDENTICAL:
						...
						&& $tokens[ ( $i + 3 ) ]['content'] === "\n"
							...
							$phpcsFile->addError( $error, $i, 'DelimiterFound', array( 'delimiter' ) );
							$i += 3;
						}
						break;
