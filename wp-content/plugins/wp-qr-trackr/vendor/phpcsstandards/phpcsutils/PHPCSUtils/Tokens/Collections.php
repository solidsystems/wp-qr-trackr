...
final class Collections {
	 ...
	 * @var array<int, int>
	 */
	private static $alternativeControlStructureSyntaxes = array(
		\T_IF      => \T_IF,
		\T_ELSEIF  => \T_ELSEIF,
		\T_ELSE    => \T_ELSE,
		\T_FOR     => \T_FOR,
	 ...
	 * @var array<int, int>
	 */
	private static $alternativeControlStructureSyntaxClosers = array(
		\T_ENDIF      => \T_ENDIF,
		\T_ENDFOR     => \T_ENDFOR,
	 ...
	 */
	private static $arrayOpenTokensBC = array(
		\T_ARRAY            => \T_ARRAY,
	 ...
	 * @var array<int|string, int|string>
	 */
	private static $arrayTokens = array(
		\T_ARRAY             => \T_ARRAY,
		\T_OPEN_SHORT_ARRAY  => \T_OPEN_SHORT_ARRAY,
	 ...
	 * @var array<int|string, int|string>
	 */
	private static $classModifierKeywords = array(
		\T_FINAL    => \T_FINAL,
	 ...
	 * @var array<int|string, int|string>
	 */
	private static $closedScopes = array(
		\T_CLASS      => \T_CLASS,
	 ...
	 * @var array<int|string, int|string>
	 */
	private static $constantModifierKeywords = array(
		\T_PUBLIC    => \T_PUBLIC,
		\T_PRIVATE   => \T_PRIVATE,
	 ...
	 * @var array<int|string, int|string>
	 */
	private static $constantTypeTokens = array(
	 ...
	 * @var array<int|string, int|string>
	 */
	private static $controlStructureTokens = array(
		\T_IF      => \T_IF,
		\T_ELSEIF  => \T_ELSEIF,
		\T_ELSE    => \T_ELSE,
		\T_FOR     => \T_FOR,
	 ...
	 * @var array<int|string, int|string>
	 */
	private static $functionDeclarationTokens = array(
		\T_FUNCTION => \T_FUNCTION,
		\T_CLOSURE  => \T_CLOSURE,
		\T_FN       => \T_FN,
	);
	 ...
	 * @var array<int, int>
	 */
	private static $incrementDecrementOperators = array(
		\T_DEC => \T_DEC,
		\T_INC => \T_INC,
	);
	 ...
	 * @var array<int|string, int|string>
	 */
	private static $listOpenTokensBC = array(
		\T_LIST             => \T_LIST,
		\T_OPEN_SHORT_ARRAY => \T_OPEN_SHORT_ARRAY,
	);
	 ...
	 * @var array<int|string, int|string>
	 */
	private static $listTokens = array(
		\T_LIST              => \T_LIST,
		\T_OPEN_SHORT_ARRAY  => \T_OPEN_SHORT_ARRAY,
		\T_CLOSE_SHORT_ARRAY => \T_CLOSE_SHORT_ARRAY,
	);
	 ...
	 * @var array<int|string, int|string>
	 */
	private static $namespaceDeclarationClosers = array(
	 ...
	 * @var array<int|string, int|string>
	 */
	private static $nameTokens = array(
		\T_STRING               => \T_STRING,
	 ...
	 * @var array<int|string, int|string>
	 */
	private static $objectOperators = array(
	 ...
	 * @var array<int|string, int|string>
	 */
	private static $ooCanExtend = array(
		\T_CLASS      => \T_CLASS,
		\T_ANON_CLASS => \T_ANON_CLASS,
		\T_INTERFACE  => \T_INTERFACE,
	);
	 ...
	 * @var array<int|string, int|string>
	 */
	private static $ooCanImplement = array(
		\T_CLASS      => \T_CLASS,
		\T_ANON_CLASS => \T_ANON_CLASS,
		\T_ENUM       => \T_ENUM,
	);
	 ...
	 * @var array<int|string, int|string>
	 */
	private static $ooConstantScopes = array(
		\T_CLASS      => \T_CLASS,
		\T_ANON_CLASS => \T_ANON_CLASS,
		\T_INTERFACE  => \T_INTERFACE,
		\T_ENUM       => \T_ENUM,
	 ...
	 * @var array<int|string, int|string>
	 */
	private static $ooHierarchyKeywords = array(
		\T_PARENT => \T_PARENT,
		\T_SELF   => \T_SELF,
		\T_STATIC => \T_STATIC,
	);
	 ...
	 * @var array<int|string, int|string>
	 */
	private static $ooPropertyScopes = array(
		\T_CLASS      => \T_CLASS,
		\T_ANON_CLASS => \T_ANON_CLASS,
		\T_INTERFACE  => \T_INTERFACE,
		\T_TRAIT      => \T_TRAIT,
	 ...
	 * @var array<int|string, int|string>
	 */
	private static $parameterTypeTokens = array(
	 ...
	 * @var array<int|string, int|string>
	 */
	private static $propertyModifierKeywords = array(
		\T_PUBLIC        => \T_PUBLIC,
	 ...
	 * @var array<int|string, int|string>
	 */
	private static $propertyTypeTokens = array(
		\T_CALLABLE               => \T_CALLABLE, // Not allowed in PHP, but in this list to allow for flagging code errors.
		\T_SELF                   => \T_SELF,
		\T_PARENT                 => \T_PARENT,
		\T_FALSE                  => \T_FALSE,
	 ...
	 * @var array<int|string, int|string>
	 */
	private static $shortArrayListOpenTokensBC = array(
		\T_OPEN_SHORT_ARRAY => \T_OPEN_SHORT_ARRAY,
	);
	 ...
	 * @var array<int|string, int|string>
	 */
	private static $shortArrayTokens = array(
		\T_OPEN_SHORT_ARRAY  => \T_OPEN_SHORT_ARRAY,
		\T_CLOSE_SHORT_ARRAY => \T_CLOSE_SHORT_ARRAY,
	);
	 ...
	 * @var array<int|string, int|string>
	 */
	private static $shortListTokens = array(
		\T_OPEN_SHORT_ARRAY  => \T_OPEN_SHORT_ARRAY,
		\T_CLOSE_SHORT_ARRAY => \T_CLOSE_SHORT_ARRAY,
	);
	 ...
	 * @var array<int|string, int|string>
	 */
	private static $ternaryOperators = array(
	 ...
	 * @var array<int|string, int|string>
	 */
	private static $textStringStartTokens = array(
