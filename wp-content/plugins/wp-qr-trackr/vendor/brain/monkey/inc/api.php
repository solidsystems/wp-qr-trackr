...
namespace Brain\Monkey\Functions {
	...
	function stubTranslationFunctions() {
		stubs(
			array(
				...
				'esc_html__'              => array( EscapeHelper::class, 'esc' ),
				'esc_html_x'              => array( EscapeHelper::class, 'esc' ),
				'esc_attr__'              => array( EscapeHelper::class, 'esc' ),
				'esc_attr_x'              => array( EscapeHelper::class, 'esc' ),
				'esc_html_e'              => array( EscapeHelper::class, 'escAndEcho' ),
				'esc_attr_e'              => array( EscapeHelper::class, 'escAndEcho' ),
	...
	function stubEscapeFunctions() {
		stubs(
			array(
				'esc_js'       => array( EscapeHelper::class, 'esc' ),
				'esc_sql'      => 'addslashes',
				'esc_attr'     => array( EscapeHelper::class, 'esc' ),
				'esc_html'     => array( EscapeHelper::class, 'esc' ),
				'esc_textarea' => array( EscapeHelper::class, 'esc' ),
				'esc_url'      => array( EscapeHelper::class, 'escUrl' ),
				'esc_url_raw'  => array( EscapeHelper::class, 'escUrlRaw' ),
				'esc_xml'      => array( EscapeHelper::class, 'escXml' ),
			)
		);
	}
}
