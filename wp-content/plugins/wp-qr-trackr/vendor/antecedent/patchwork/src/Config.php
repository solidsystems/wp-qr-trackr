...
function set( array $data, $file ) {
	...
	$list    = array( 'blacklist', 'whitelist', 'cache-path', 'redefinable-internals', 'new-keyword-redefinable' );
...
class State {
	...
	static $cachePath;
	static $redefinableInternals          = array();
	static $redefinableLanguageConstructs = array();
