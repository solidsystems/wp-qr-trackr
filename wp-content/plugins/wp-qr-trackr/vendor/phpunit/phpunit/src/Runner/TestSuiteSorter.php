...
final class TestSuiteSorter {
	...
	private const SIZE_SORT_WEIGHT = array(
		'small'   => 1,
		'medium'  => 2,
		'large'   => 3,
		'unknown' => 4,
	...
	private function resolveDependencies( array $tests ): array {
		...
		do {
			if ( array() === array_diff( $tests[ $i ]->requires(), $provided ) ) {
