...
final class Generator {
	 ...
	 * @var array
	 */
	private const EXCLUDED_METHOD_NAMES = array(
		'__CLASS__'       => true,
		'__DIR__'         => true,
		'__FILE__'        => true,
		'__FUNCTION__'    => true,
	 ...
	 */
	public function testDouble( string $type, bool $mockObject, ?array $methods = array(), array $arguments = array(), string $mockClassName = '', bool $callOriginalConstructor = true, bool $callOriginalClone = true, bool $callAutoload = true, bool $cloneArguments = true, bool $callOriginalMethods = false, ?object $proxyTarget = null, bool $allowMockingUnknownTypes = true, bool $returnValueGeneration = true ): MockObject|Stub {
	 ...
	 */
	public function mockObjectForAbstractClass( string $originalClassName, array $arguments = array(), string $mockClassName = '', bool $callOriginalConstructor = true, bool $callOriginalClone = true, bool $callAutoload = true, ?array $mockedMethods = null, bool $cloneArguments = true ): MockObject {
		if ( class_exists( $originalClassName, $callAutoload ) ||
			...
			foreach ( $reflector->getMethods() as $method ) {
				if ( $method->isAbstract() && ! in_array( $method->getName(), $methods ?? array(), true ) ) {
	 ...
	 */
	public function mockObjectForTrait( string $traitName, array $arguments = array(), string $mockClassName = '', bool $callOriginalConstructor = true, bool $callOriginalClone = true, bool $callAutoload = true, ?array $mockedMethods = null, bool $cloneArguments = true ): MockObject {
	 ...
	 */
	public function objectForTrait( string $traitName, string $traitClassName = '', bool $callAutoload = true, bool $callOriginalConstructor = false, array $arguments = array() ): object {
		if ( ! trait_exists( $traitName, $callAutoload ) ) {
			throw new UnknownTraitException( $traitName );
		}
	 ...
	 */
	public function generateClassFromWsdl( string $wsdlFile, string $className, array $methods = array(), array $options = array() ): string {
	 ...
	 * @throws RuntimeException
	 */
	private function getObject( MockType $mockClass, string $type = '', bool $callOriginalConstructor = false, array $arguments = array(), bool $callOriginalMethods = false, ?object $proxyTarget = null, bool $returnValueGeneration = true ): object {
	...
	private function generateCodeForTestDoubleClass( string $type, bool $mockObject, ?array $explicitMethods, string $mockClassName, bool $callOriginalClone, bool $callAutoload, bool $cloneArguments, bool $callOriginalMethods ): MockClass {
		...
		if ( $isClass && $explicitMethods === array() ) {
			$mockMethods->addMethods(
				...$this->mockClassMethods( $_mockClassName['fullClassName'], $callOriginalMethods, $cloneArguments ),
			);
		}

		if ( $isInterface && ( $explicitMethods === array() || $explicitMethods === null ) ) {
			$mockMethods->addMethods(
	...
	private function generateTestDoubleClassDeclaration( bool $mockObject, array $mockClassName, bool $isInterface, array $additionalInterfaces = array() ): string {
		if ( $mockObject ) {
