...
abstract class TestCase extends Assert implements Reorderable, SelfDescribing, Test {
	...
	private const LOCALE_CATEGORIES = array( LC_ALL, LC_COLLATE, LC_CTYPE, LC_MONETARY, LC_NUMERIC, LC_TIME );
	...
	final public function setName( string $name ): void {
		...
		if ( is_callable( $this->sortId(), true ) ) {
			$this->providedTests = array( new ExecutionOrderDependency( $this->sortId() ) );
		}
	}
	 ...
	 */
	protected function createTestProxy( string $originalClassName, array $constructorArguments = array() ): MockObject {
	 ...
	 */
	protected function getMockForAbstractClass( string $originalClassName, array $arguments = array(), string $mockClassName = '', bool $callOriginalConstructor = true, bool $callOriginalClone = true, bool $callAutoload = true, array $mockedMethods = array(), bool $cloneArguments = false ): MockObject {
	 ...
	 */
	protected function getMockFromWsdl( string $wsdlFile, string $originalClassName = '', string $mockClassName = '', array $methods = array(), bool $callOriginalConstructor = true, array $options = array() ): MockObject {
	 ...
	 */
	protected function getMockForTrait( string $traitName, array $arguments = array(), string $mockClassName = '', bool $callOriginalConstructor = true, bool $callOriginalClone = true, bool $callAutoload = true, array $mockedMethods = array(), bool $cloneArguments = false ): MockObject {
	 ...
	 */
	protected function getObjectForTrait( string $traitName, array $arguments = array(), string $traitClassName = '', bool $callOriginalConstructor = true, bool $callOriginalClone = true, bool $callAutoload = true ): object {
	...
	private function handleDependencies(): bool {
		if ( array() === $this->dependencies || $this->inIsolation ) {
			return true;
		}
	...
	private function requirementsNotSatisfied(): bool {
		return ( new Requirements() )->requirementsNotSatisfiedFor( static::class, $this->name ) !== array();
	}
