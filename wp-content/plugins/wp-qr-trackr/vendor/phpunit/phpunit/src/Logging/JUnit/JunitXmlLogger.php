...
final class JunitXmlLogger {
	 ...
	 * @var DOMElement[]
	 */
	private array $testSuites = array();

	/**
	 * @psalm-var array<int,int>
	 */
	private array $testSuiteTests = array( 0 );

	/**
	 * @psalm-var array<int,int>
	 */
	private array $testSuiteAssertions = array( 0 );

	/**
	 * @psalm-var array<int,int>
	 */
	private array $testSuiteErrors = array( 0 );

	/**
	 * @psalm-var array<int,int>
	 */
	private array $testSuiteFailures = array( 0 );

	/**
	 * @psalm-var array<int,int>
	 */
	private array $testSuiteSkipped = array( 0 );

	/**
	 * @psalm-var array<int,int>
	 */
	private array $testSuiteTimes        = array( 0 );
