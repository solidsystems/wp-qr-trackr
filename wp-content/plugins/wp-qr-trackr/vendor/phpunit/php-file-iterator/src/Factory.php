...
final class Factory {
	 ...
	 */
	public function getFileIterator( array|string $paths, array|string $suffixes = '', array|string $prefixes = '', array $exclude = array() ): AppendIterator {
		if ( is_string( $paths ) ) {
			$paths = array( $paths );
		}
