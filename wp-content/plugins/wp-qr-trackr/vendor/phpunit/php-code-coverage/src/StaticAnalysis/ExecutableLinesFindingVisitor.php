...
final class ExecutableLinesFindingVisitor extends NodeVisitorAbstract {
	 ...
	 * @psalm-var LinesType
	 */
	private array $executableLinesGroupedByBranch = array();

	/**
	 * @psalm-var array<int, bool>
	 */
	private array $unsets = array();

	/**
	 * @psalm-var array<int, string>
	 */
	private array $commentsToCheckForUnset = array();
