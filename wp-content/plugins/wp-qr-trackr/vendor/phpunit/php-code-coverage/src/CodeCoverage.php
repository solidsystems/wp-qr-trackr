...
final class CodeCoverage {
	 ...
	 */
	private array $linesToBeIgnored = array();
	 ...
	 */
	private array $parentClassesExcludedFromUnintentionallyCoveredCodeCheck = array();
	 ...
	 */
	public function stop( bool $append = true, ?TestStatus $status = null, array|false $linesToBeCovered = array(), array $linesToBeUsed = array(), array $linesToBeIgnored = array() ): RawCodeCoverageData {
	 ...
	 */
	public function append( RawCodeCoverageData $rawData, ?string $id = null, bool $append = true, ?TestStatus $status = null, array|false $linesToBeCovered = array(), array $linesToBeUsed = array(), array $linesToBeIgnored = array() ): void {
		if ( $id === null ) {
			$id = $this->currentId;
		}
	...
	private function performUnintentionallyCoveredCodeCheck( RawCodeCoverageData $data, array $linesToBeCovered, array $linesToBeUsed ): void {
		...
		$unintentionallyCoveredUnits = array();
