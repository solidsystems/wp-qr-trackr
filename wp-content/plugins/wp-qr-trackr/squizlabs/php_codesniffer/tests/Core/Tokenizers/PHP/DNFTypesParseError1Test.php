...
final class DNFTypesParseError1Test extends AbstractTokenizerTestCase {
	...
	public static function dataBrokenDNFTypeCantEndOnOpenParenthesis() {
		return array(
			'OO const type'    => array( '/* testBrokenConstDNFTypeEndOnOpenParenthesis */' ),
			'OO property type' => array( '/* testBrokenPropertyDNFTypeEndOnOpenParenthesis */' ),
			'Parameter type'   => array( '/* testBrokenParamDNFTypeEndOnOpenParenthesis */' ),
			'Return type'      => array( '/* testBrokenReturnDNFTypeEndOnOpenParenthesis */' ),
		);
