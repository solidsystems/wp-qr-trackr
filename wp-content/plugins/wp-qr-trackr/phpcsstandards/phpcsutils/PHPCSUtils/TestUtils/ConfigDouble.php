...
final class ConfigDouble extends Config {
	 ...
	 * @return void
	 */
	public function __construct( array $cliArgs = array(), $skipSettingStandard = false, $skipSettingReportWidth = false ) {
	...
	public function __destruct() {
		$this->setStaticConfigProperty( 'overriddenDefaults', array() );
		$this->setStaticConfigProperty( 'executablePaths', array() );
	...
	private function preventReadingCodeSnifferConfFile() {
		$this->setStaticConfigProperty( 'configData', array() );
